...
<p align="center"><a href="#"><img src="./media/XX-UI.png" alt="Image"></a></p>

**Un Panel Web Avanzado • Construido sobre Xray Core**

[![](https://img.shields.io/github/v/release/xqqman/xx-ui.svg)](https://github.com/xqqman/xx-ui/releases)
[![](https://img.shields.io/github/actions/workflow/status/xqqman/xx-ui/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/xqqman/xx-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/xqqman/xx-ui/total.svg)](#)
...
<p align="left"><a href="#"><img width="125" src="https://github.com/xqqman/xx-ui/assets/115543613/7aa895dd-048a-42e7-989b-afd41a74e2e1" alt="Image"></a></p>
...
```
bash <(curl -Ls https://raw.githubusercontent.com/xqqman/xx-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/xqqman/xx-ui/master/install.sh) v2.2.8
```
...
wget https://github.com/xqqman/xx-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. Clona el Repositorio del Proyecto:
   ...
   ```sh
   git clone https://github.com/xqqman/xx-ui.git
   cd xx-ui
   ```
...
actualizar a la última versión
   ...
   ```sh
    cd xx-ui
    docker compose down
    docker compose pull xx-ui
    docker compose up -d
   ```

eliminar xx-ui de docker
...
[![Stargazers over time](https://starchart.cc/xqqman/xx-ui.svg)](https://starchart.cc/xqqman/xx-ui)
